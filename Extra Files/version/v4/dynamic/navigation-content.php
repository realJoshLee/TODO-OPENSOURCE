<div class="nav-content">
  <div class="nav-small">
    <div class="nav-toggle-btn-container">
      <span class="nav-btn" onclick="closenav()">&times;</span>
    </div>
  </div>
  ...
  <div class="main-btns nav">
    ...
    <span class="navbtn desktop-nav-button" onclick="closenav()"><i class="fas fa-arrow-left"></i></span>&nbsp;&nbsp;&nbsp;<span class="goal"><i class="far fa-check-square"></i>&nbsp;&nbsp;<span class="complete-tasks" id="counter"><?php echo $cttoday; ?></span>/<?php echo $goal; ?></span>
    </button>
    <!--Today button-->
