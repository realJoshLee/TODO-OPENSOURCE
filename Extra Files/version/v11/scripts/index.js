...
function statsactive() {
  ...
  $( ".inbox-nav, .planning-nav, .setting-btn, .log-nav, .folder-btn, .alerts-nav" ).removeClass('active').addClass('');
...
function planningactive() {
  ...
  $( ".inbox-nav, .settings-btn, .log-nav, .folder-btn, .stats-nav, .alerts-nav" ).removeClass('active').addClass('');
...
function inboxactive() {
  ...
  $( ".planning-nav, .settings-btn, .log-nav, .folder-btn, .stats-nav, .alerts-nav" ).removeClass('active').addClass('');
...
$(document).on('click', '.folder-btn', function(){
  ...
  $( ".inbox-nav, .planning-nav, .settings-btn, .log-nav, .folder-btn, .stats-nav, .alerts-nav" ).removeClass('active').addClass('');
...
function settingsactive() {
  ...
  $( ".inbox-nav, .planning-nav, .log-nav, .folder-btn, .stats-nav, .alerts-nav" ).removeClass('active').addClass('');
...
xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
*/
// Everything that controls the changing for the light theme
function themelight() {
...
// Everything that controls the changing for the dark theme
function themedark() {
...
// Everything that controls the changing for the black theme
function themeblack() {
