            ...
            <ul class="account-settings-container">
              ...
              <li class="account-setting">
                ...
                <form action="email-update.php" method="post">
                  <input id="form" type="email" placeholder="Type New Email Here" name="email" class="change-email-container">&nbsp;&nbsp;&nbsp;<input id="form-button" type="submit" value="Change Email" class="change-email-submit">
                </form>
              </li>
