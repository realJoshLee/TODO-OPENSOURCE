...
$dbJune = "SELECT * FROM `tasks_tasks` WHERE completemonth = 'June' AND account = '$account' AND completeyear = '$year'";
$connStatusJune = $conn->query($dbJune);
$June = mysqli_num_rows($connStatusJune);

$dbJuly = "SELECT * FROM `tasks_tasks` WHERE completemonth = 'Jule' AND account = '$account' AND completeyear = '$year'";
