<svg class="navsizing" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 457.811 456.94">
  <g id="Calendar" transform="translate(-20.09 -20.997)">
    <path id="Path_21" data-name="Path 21" d="M0,0C38.564-39.217,325.186-34.708,362,0s37.585,326.313,0,362S35.835,398.814,0,362-38.564,39.217,0,0Z" transform="translate(68 68.748)" fill="none" stroke="<?php echo $navcolor; ?>" stroke-width="40"/>
    ...
    <g id="Dates" transform="translate(3 23)" fill="<?php echo $navcolor; ?>">
