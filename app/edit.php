<?php
  ...
  $todayitemsget = $db->prepare("SELECT * FROM `tasks` WHERE `account` = :account AND `id` = :id ORDER BY `completed` ASC");
  ...
  $subtaskget = $db->prepare("SELECT * FROM `tasks` WHERE `account` = :account AND `parenttaskid` = :id ORDER BY `completed` ASC");
      ...
      <div class="edit-inner">
        <?php foreach($todayitems as $item): ?>
          <form method="POST">
            ...
            <input name="date" type="text" class="form-control" required autocomplete="off" value="<?php echo $item['date']; ?>"><br><br>
            ...
            <a action="action" href="index.php" class="submit">Cancel</a>
              ...
              <script>
                $(document).ready(function(){
                  ...
                  else
                  {
                    ...
                    $.ajax({
                    url:"add_subtask.php?parent=<?php echo $itemid; ?>",
                    method:"POST",
                    data:$(this).serialize(),
