...
if(isset($_GET['as'])){
  ...
  switch ($action) {
    ...
    */
    ...
    case "dailygoalupdate":    
      ...
      $logQuery = $db->prepare("
        ...
        VALUES (:account, :content, :date)
      ");
      $content = 'Updated daily goal ('.$_GET['goal'].')';
      $logQuery->execute([
        ':account' => $account,
        ':content' => $content,
        ':date' => $logdate
    ...
    case "theme":
      ...
      $logQuery = $db->prepare("
        ...
        VALUES (:account, :content, :date)
      ");
      $content = 'Updated theme ('.$_GET['theme'].')';
      $logQuery->execute([
        ':account' => $account,
        ':content' => $content,
        ':date' => $logdate
    ...
    */
    ...
    case "subtaskupdate":   
      $encsubtask = base64_encode(openssl_encrypt($_GET['content'], $method, $key, OPENSSL_RAW_DATA, $iv));
