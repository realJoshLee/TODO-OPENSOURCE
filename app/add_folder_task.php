...
if($_POST["task_name"])
{
  ...
  (account, name, parentfolder) 
  VALUES (:account, :name, :parentfolder)
  ";
      ...
      <span class="rownav" id="hovereffect">
        ...
        <span class="columnnav textbox">
          ...
          <div class="dropdown dropdown-'.$id.'" data-id="'.$id.'">
            ...
            <!--Grey-->
            <a href="actions-folder-tasks.php?as=default&item='.$id.'" class="navlink"><span style="height: 16px; width: 16px; display: inline-block; border: 2px solid grey; border-radius: 6px; font-size: 10px; background-color: transparent;" class="checkboxcolor"></span></a>

            &nbsp;

            <!--Red-->
            <a href="actions-folder-tasks.php?as=red&item='.$id.'" class="navlink"><span style="height: 16px; width: 16px; display: inline-block; border: 2px solid #ff006a; border-radius: 6px; font-size: 10px; background-color: #fccce1;" class="checkboxcolor"></span></a>

            &nbsp;

            <!--Green-->
            <a href="actions-folder-tasks.php?as=green&item='.$id.'" class="navlink"><span style="height: 16px; width: 16px; display: inline-block; border: 2px solid #00ff26; border-radius: 6px; font-size: 10px; background-color: #dbffe1;" class="checkboxcolor"></span></a>

            &nbsp;

            <!--Blue-->
            <a href="actions-folder-tasks.php?as=blue&item='.$id.'" class="navlink"><span style="height: 16px; width: 16px; display: inline-block; border: 2px solid #006fff; border-radius: 6px; font-size: 10px; background-color: #cfe4ff;" class="checkboxcolor"></span></a>

            &nbsp;

            <!--Orange-->
            <a href="actions-folder-tasks.php?as=orange&item='.$id.'" class="navlink"><span style="height: 16px; width: 16px; display: inline-block; border: 2px solid #ff5900; border-radius: 6px; font-size: 10px; background-color: #ffe3d4;" class="checkboxcolor"></span></a>
