<div class="content">
  <div class="day-container nav-content">
    ...
    <div class="dailygoal">
      ...
      <p>This if your identifier code for your account that you will use for the Chrome Extension. This code has access to only add tasks to your account.</p>
      <span class="blue"><?php echo $identifier; ?></span>
    </div>
