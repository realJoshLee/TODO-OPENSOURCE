...
function todayactive() {
  ...
  // Changes the view
  $('.inbox-page, .settings-page, .log-page, [id^=fdiv-], .stats-page, .alerts-page').css('display','none');
  $( ".inbox-nav, .settings-btn, .log-nav, .folder-btn, .stats-nav, .alerts-nav, .planning-nav" ).removeClass('active').addClass('');
...
function statsactive() {
  ...
  // Changes the view
  $('.inbox-page, .insight-page, .settings-page, .log-page, [id^=fdiv-], .alerts-page').css('display','none');
  $( ".inbox-nav, .planning-nav, .setting-btn, .log-nav, .folder-btn, .alerts-nav, .today-nav" ).removeClass('active').addClass('');
...
function planningactive() {
  ...
  // Changes the view
  $('.inbox-page, .settings-page, .log-page, [id^=fdiv-], .stats-page, .alerts-page').css('display','none');
  $( ".inbox-nav, .settings-btn, .log-nav, .folder-btn, .stats-nav, .alerts-nav, .today-nav" ).removeClass('active').addClass('');
...
function inboxactive() {
  ...
  $('.insight-page, .settings-page, .log-page, [id^=fdiv-], .stats-page, .alerts-page').css('display','none');
  $( ".planning-nav, .settings-btn, .log-nav, .folder-btn, .stats-nav, .alerts-nav, .today-nav" ).removeClass('active').addClass('');
...
$(document).on('click', '.folder-btn', function(){
  ...
  // Changes the view
  $('.inbox-page, .insight-page, .settings-page, .log-page, [id^=fdiv-], .stats-page, .alerts-page').css('display','none');
  $( ".inbox-nav, .planning-nav, .settings-btn, .log-nav, .folder-btn, .stats-nav, .alerts-nav, .today-nav" ).removeClass('active').addClass('');
...
function alertsactive() {
  ...
  $( ".inbox-nav, .planning-nav, .settings-btn, .log-nav, .folder-btn, .stats-nav, .today-nav" ).removeClass('active').addClass('');
...
function settingsactive() {
  ...
  // Changes the view
  $('.inbox-page, .insight-page, .log-page, [id^=fdiv-], .stats-page, .alerts-page').css('display','none');
  $( ".inbox-nav, .planning-nav, .log-nav, .folder-btn, .stats-nav, .alerts-nav, .today-nav" ).removeClass('active').addClass('');
