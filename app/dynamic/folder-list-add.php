<div class="folderlist app-page" id="fdiv-${fid}" data-id="${fid}">
  <div class="content">
    <h2><span class="day" id="fn-${fid}">${foldervar}</span> &nbsp;&nbsp;<span style="float:right;" class="edit-folder-content" data-id="${fid}"><span class="f-edit"><i class="fas fa-ellipsis-h"></i></span></span></h2>
