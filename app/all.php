...
<?php
  ...
  $itemsQuery = $db->prepare("SELECT id, name, folder, done FROM tasks WHERE user = :user");
	...
	<body>
      ...
      <div class="row">
        ...
        <div id="settings" class="column">
          <!--Folder Selection-->
          <div class="folders">
            <a href="all.php" class="folder-link-button left"><img src="assets/images/globe-active.svg" id="folder-icon" class="inbox-button"></a>
            <a href="index.php" class="folder-link-button"><img src="assets/images/inbox-707070.svg" id="folder-icon" class="inbox-button"></a>
        ...
        <div id="task-lists" class="column">
          <!--Header Title-->
          <h2 class="header">All Tasks:</h2>
          <p>This page shows all of the tasks in all folders, even the bookmarked folder.</p>
