    ...
    <div class="content">
      ...
      <?php if ($_GET['p']=='resources'): ?>
        ...
        <div class="main-content settings-content">
          ...
          <a download href="../icons/check.svg" class="resource-link"><img src="../icons/check.svg" alt="" class="resource-logo"> check.svg</a><br>
          <a download href="../icons/check.png" class="resource-link"><img src="../icons/check.png" alt="" class="resource-logo"> check.png</a><br>
          <a download href="../icons/favicon.png" class="resource-link"><img src="../icons/favicon.png" alt="" class="resource-logo"> favicon.png</a><br>
          <a download href="../icons/landing.png" class="resource-link"><img src="../icons/landing.png" alt="" class="resource-logo"> landing.png</a><br>
          <a download href="../icons/favicon.ico" class="resource-link"><img src="../icons/favicon.ico" alt="" class="resource-logo"> favicon.ico</a><br>

          <br><br>

          <a download href="../icons/shadow-icons/favicon-shadow.png" class="resource-link"><img src="../icons/shadow-icons/favicon-shadow.png" alt="" class="resource-logo"> favicon-shadow.png</a><br>
          <a download href="../icons/shadow-icons/favicon-shadow.svg" class="resource-link"><img src="../icons/shadow-icons/favicon-shadow.svg" alt="" class="resource-logo"> favicon-shadow.svg</a><br>
          <a download href="../icons/shadow-icons/favicon-shadow-192.png" class="resource-link"><img src="../icons/shadow-icons/favicon-shadow-192.png" alt="" class="resource-logo"> favicon-shadow-192.png</a><br>
          <a download href="../icons/shadow-icons/favicon-shadow-192.svg" class="resource-link"><img src="../icons/shadow-icons/favicon-shadow-192.svg" alt="" class="resource-logo"> favicon-shadow-192.svg</a><br>
          <a download href="../icons/shadow-icons/favicon-shadow-256.png" class="resource-link"><img src="../icons/shadow-icons/favicon-shadow-256.png" alt="" class="resource-logo"> favicon-shadow-256.png</a><br>
          <a download href="../icons/shadow-icons/favicon-shadow-256.svg" class="resource-link"><img src="../icons/shadow-icons/favicon-shadow-256.svg" alt="" class="resource-logo"> favicon-shadow-256.svg</a><br>
          <a download href="../icons/shadow-icons/favicon-shadow-384.png" class="resource-link"><img src="../icons/shadow-icons/favicon-shadow-384.png" alt="" class="resource-logo"> favicon-shadow-384.png</a><br>
          <a download href="../icons/shadow-icons/favicon-shadow-384.svg" class="resource-link"><img src="../icons/shadow-icons/favicon-shadow-384.svg" alt="" class="resource-logo"> favicon-shadow-384.svg</a><br>
          <a download href="../icons/shadow-icons/favicon-shadow-512.png" class="resource-link"><img src="../icons/shadow-icons/favicon-shadow-512.png" alt="" class="resource-logo"> favicon-shadow-512.png</a><br>
          <a download href="../icons/shadow-icons/favicon-shadow-512.svg" class="resource-link"><img src="../icons/shadow-icons/favicon-shadow-512.svg" alt="" class="resource-logo"> favicon-shadow-512.svg</a><br>

          <br><br>

          <a download href="../icons/archived_files/spinner.gif" class="resource-link"><img src="../icons/archived_files/spinner.gif" alt="" class="resource-logo"> spinner.gif</a><br>
          <a download href="../icons/archived_files/times-circle-regular.svg" class="resource-link"><img src="../icons/archived_files/times-circle-regular.svg" alt="" class="resource-logo"> times-circle-regular.svg</a><br>
          <a download href="../icons/archived_files/trash.svg" class="resource-link"><img src="../icons/archived_files/trash.svg" alt="" class="resource-logo"> trash.svg</a><br>

          <br><br>

          <a download href="../icons/quick-icons/Calendar.png" class="resource-link"><img src="../icons/quick-icons/Calendar.png" alt="" class="resource-logo"> calendar.png</a><br>
          <a download href="../icons/quick-icons/Inbox.png" class="resource-link"><img src="../icons/quick-icons/Inbox.png" alt="" class="resource-logo"> inbox.png</a><br>
          <a download href="../icons/quick-icons/Links.png" class="resource-link"><img src="../icons/quick-icons/Links.png" alt="" class="resource-logo"> links.png</a><br>
          <a download href="../icons/quick-icons/Today.png" class="resource-link"><img src="../icons/quick-icons/Today.png" alt="" class="resource-logo"> today.png</a><br>
          <a download href="../icons/nav-icons/Alerts-NoGradient.svg" class="resource-link"><img src="../icons/nav-icons/Alerts-NoGradient.svg" alt="" class="resource-logo"> alerts-nogradient.svg</a><br>
          <a download href="../icons/nav-icons/log.svg" class="resource-link"><img src="../icons/nav-icons/log.svg" alt="" class="resource-logo"> log.svg</a><br>
          <a download href="../icons/nav-icons/stats.svg" class="resource-link"><img src="../icons/nav-icons/stats.svg" alt="" class="resource-logo"> stats.svg</a><br>

          <br><br>

          <a download href="../icons/colored-folder-icons/folder-02b96e.svg" class="resource-link"><img src="../icons/colored-folder-icons/folder-02b96e.svg" alt="" class="resource-logo"> folder-02b96e.svg</a><br>
          <a download href="../icons/colored-folder-icons/folder-2ed9ba.svg" class="resource-link"><img src="../icons/colored-folder-icons/folder-2ed9ba.svg" alt="" class="resource-logo"> folder-2ed9ba.svg</a><br>
          <a download href="../icons/colored-folder-icons/folder-7c3ffd.svg" class="resource-link"><img src="../icons/colored-folder-icons/folder-7c3ffd.svg" alt="" class="resource-logo"> folder-7c3ffd.svg</a><br>
          <a download href="../icons/colored-folder-icons/folder-575b68.svg" class="resource-link"><img src="../icons/colored-folder-icons/folder-575b68.svg" alt="" class="resource-logo"> folder-575b68.svg</a><br>
          <a download href="../icons/colored-folder-icons/folder-4169e1.svg" class="resource-link"><img src="../icons/colored-folder-icons/folder-4169e1.svg" alt="" class="resource-logo"> folder-4169e1.svg</a><br>
          <a download href="../icons/colored-folder-icons/folder-aa100c.svg" class="resource-link"><img src="../icons/colored-folder-icons/folder-aa100c.svg" alt="" class="resource-logo"> folder-aa100c.svg</a><br>
          <a download href="../icons/colored-folder-icons/folder-f76ee4.svg" class="resource-link"><img src="../icons/colored-folder-icons/folder-f76ee4.svg" alt="" class="resource-logo"> folder-f76ee4.svg</a><br>
          <a download href="../icons/colored-folder-icons/folder-fe6b55.svg" class="resource-link"><img src="../icons/colored-folder-icons/folder-fe6b55.svg" alt="" class="resource-logo"> folder-fe6b55.svg</a><br>
          <a download href="../icons/colored-folder-icons/folder-ff3970.svg" class="resource-link"><img src="../icons/colored-folder-icons/folder-ff3970.svg" alt="" class="resource-logo"> folder-ff3970.svg</a><br>
          <a download href="../icons/colored-folder-icons/folder-ffa311.svg" class="resource-link"><img src="../icons/colored-folder-icons/folder-ffa311.svg" alt="" class="resource-logo"> folder-ffa311.svg</a><br>
