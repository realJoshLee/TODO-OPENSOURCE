<div class="nav-content">
  ...
  <div class="main-btns nav">
    ...
    <button class="nav-btn-container goal-style">
      <span class="navbtn desktop-nav-button" onclick="closenav()"><i class="fas fa-arrow-left"></i></span>&nbsp;&nbsp;&nbsp;
    ...
    <button class="nav-btn-container alerts-nav" onclick="alertsactive()" data-btn="alerts">
      <img src="icons/nav-icons/Alerts.svg" alt="" class="nav-icon"><span class="nav-text">Alerts</span>
    </button>
  </div>
