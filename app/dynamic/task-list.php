      ...
      <div data-draggable="stop" class="task-overlay" id="overlay-<?php echo $item['tid']; ?>">
        <div class="overlay-padding-top">
          <div class="task-text">
            ...
            <input type="text" name="date" value="<?php echo $item['scheduledate']; ?>" style="width:70%!important;" id="date-<?php echo $item['tid']; ?>" class="form-control" data-id="<?php echo $item['tid']; ?>">            

            <span style="float:right;"><span class="task-save-date enlarge-mobile" data-id="<?php echo $item['tid']; ?>"><i class="far fa-check-circle"></i></span>&nbsp;&nbsp;&nbsp;
            <span class="remove-date enlarge-mobile" data-id="<?php echo $item['tid']; ?>"><i class="far fa-times-circle"></i></span></span>
