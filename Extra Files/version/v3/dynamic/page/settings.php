<div class="content">
  <div class="day-container nav-content">
    ...
    <div class="guide">
      <h3>Useful Links</h3>
      <a href="getting-started/getting-started.html" target="_blank" class="folderbacklink"><i class="fas fa-book"></i>&nbsp;&nbsp;Getting Started Document</a><br>
      <a href="change-log.html" target="_blank" class="folderbacklink"><i class="fas fa-book"></i>&nbsp;&nbsp;Change Log</a><br>
      <a href="bug.html" target="_blank" class="folderbacklink"><i class="fas fa-book"></i>&nbsp;&nbsp;Submit a Issue</a><br>
    </div>
    ...
    <div class="download">
      ...
      <a href="files/android_app-tasks.madebyjoshlee.com.apk" class="folderbacklink"><i class="fab fa-android"></i>&nbsp;&nbsp;Get Android App</a><br>
      <a href="files/windows_app-tasks.madebyjoshlee.com.exe" class="folderbacklink"><i class="fab fa-windows"></i>&nbsp;&nbsp;Get Windows App</a><br>
    </div>
