          ...
          <div class="navone" id="navone">
            ...
            <div class="navitem">
              <div id="active-change-today" class="active">
                <!--Today-->
                <button onclick="todayActive()" id="todayactive" class="" data-content="today"><?php include('icons/nav/today.php'); ?>&nbsp;&nbsp;<span class="navtext">Today</span></button>
              </div>
            </div>

            <div class="navitem">
              <div id="active-change-tomorrow" class="active">
                <!--Today-->
                <button onclick="tomorrowActive()" id="tomorrowactive" class=""><?php include('icons/nav/tomorrow.php'); ?>&nbsp;&nbsp;<span class="navtext">Tomorrow</span></button>
              </div>
            </div>
            ...
            <!--<div class="navitem">
              <div id="active-change-overview" class="active">
                <button onclick="overviewActive()" id="overviewactive" class=""><?php //include('icons/nav/glance.php'); ?>&nbsp;&nbsp;<span class="navtext">Todays Overview</span></button>
              </div>
            </div>-->
