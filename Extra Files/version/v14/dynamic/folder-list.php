...
<div class="folderlist" id="fdiv-<?php echo $fitem['fid']; ?>" data-id="<?php echo $fitem['fid']; ?>">
  <div class="content">
    <h2><span class="day" id="fn-<?php echo $fitem['fid']; ?>"><?php echo $decfolder; ?></span> &nbsp;&nbsp;<span style="float:right;" class="edit-folder-content" data-id="<?php echo $fitem['fid']; ?>"><span class="f-edit"><i class="fas fa-ellipsis-h"></i></span></span></h2>
