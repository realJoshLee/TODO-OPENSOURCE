            ...
            <section class="hero text-center">
                <div class="container-sm">
                    <div class="hero-inner">
                        ...
                        <a class="button button-primary button-shadow" href="login.php">Signup</a> 
                        ...
                        <div class="hero-browser">
                            ...
                            <div class="hero-browser-inner is-revealing">
                                ...
                                <img src="dist/devices-nobg.png" alt="" class="ipad" width="800" height="450">
                            </div>
                ...
                <div class="container-sm">
                    <div class="newsletter-inner section-inner">
                        <div class="newsletter-header text-center is-revealing">
                            ...
                            <p class="section-paragraph">Click the button below and we'll take you right to the sign in page. Answer a couple quick questions and we'll send you on your road to getting things done.</p>
                        </div>
            ...
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <ul class="footer-links list-reset">
                        ...
                        <li>
                            <a href="mailto:contact@madebyjoshlee.com">Contact</a>
                        </li>
                    </ul>
...
<?php include('include-all-user-pages.php'); ?>