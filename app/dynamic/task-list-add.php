  <div data-draggable="item" class="task task-main task-${taskid}" data-id="${taskid}">
    <div class="task-row" data-id="${taskid}">
      ...
      <div class="task-column task-right" data-id="${taskid}">
        <span id="td-${taskid}"></span><span id="count-${taskid}"></span><span id="notesnoti-${taskid}"></span><span id="remindernoti-${taskid}"></span><span class="task-edit" id="pv-task-${taskid}" data-id="${taskid}">${taskvar}</span>
      </div>
