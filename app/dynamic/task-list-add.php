      ...
      <div data-draggable="stop" class="task-overlay" id="overlay-${taskid}">
        <div class="overlay-padding-top">
          <div class="task-text">
            ...
            <span style="float:right;"><span class="task-save-date enlarge-mobile" data-id="${taskid}"><i class="far fa-check-circle"></i></span>&nbsp;&nbsp;&nbsp;
            <span class="remove-date enlarge-mobile" data-id="${taskid}"><i class="far fa-times-circle"></i></span></span>
